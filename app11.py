...
def handle_message(event):
    ...
    if event.message.text==u"==":
        ...
        line_bot_api.reply_message(event.reply_token,VideoSendMessage(original_content_url='https://github.com/luarn/linebot11/blob/master/xmas.MP4',
        ...
        line_bot_api.reply_message(event.reply_token,AudioSendMessage(original_content_url='https://github.com/luarn/linebot11/blob/master/1.mp3', duration=100000))
